...
2. Git 저장소 설정 및 초기화
   ...
   - [README.md](http://README.md) 파일을 생성하고 프로젝트 제목을 작성한다.
...
11. 코드 구조  
    ...
    \* 기능별로 함수를 분리한다.  
    \* 예: show\_menu(), add\_prompt(), show\_list(), search\_prompt(), show\_favorites()
12. [README.md](http://README.md) 작성  
...
2. 보너스 2 – 프롬프트 관리(CRUD) 및 사용 기록 기능 구현
   1. 프롬프트 수정/삭제 기능을 추가한다.
   2. 상세 보기 시 사용 횟수(조회수)를 기록한다.
   3. 조회수 기준 정렬(Top 목록) 기능을 제공한다.
